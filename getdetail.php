...
<body>
    ...
    <table class="flat-table-1">
        ...
        <tr>
			...
			<td>
				<form action="user.php" method="post" class="view">
					<button class="button1"type="submit" name="name" value="Neeraj">View</button>
				</form>
			</td>
		</tr>
        <tr>
			...
			<td>
				<form action="user.php" method="post" class="view">
					<button class="button1"type="submit" name="name" value="Vinod">View</button>
				</form>
			</td>
		</tr>
        <tr>
